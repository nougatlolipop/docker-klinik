                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <?php if ($validation->hasError('pasienName')) : ?>
                                <?= view('layout/templateAlertIcon', ['msg' => ['danger', 'fas fa-exclamation', 'Gagal!', $validation->getError('pasienName')]]); ?>
                            <?php endif; ?>
            ...
            <form action="/pasien" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input name="pasienName" type="text" class="form-control">
                    </div>
                </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="edit<?= $edit->uuid ?>">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="/pasien/<?= $edit->uuid ?>" method="post">
                    <?= csrf_field(); ?>
                    <input type="hidden" name="_method" value="PUT">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nama Pasien</label>
                            <input name="pasienName" type="text" class="form-control" value="<?= $edit->pasienName ?>">
                        </div>
                    </div>
                    <div class="modal-footer bg-whitesmoke br">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="delete<?= $hapus->uuid; ?>">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah kamu benar ingin menghapus data <strong><?= $hapus->pasienName; ?></strong>?</p>
                    <p class="text-warning"><small>This action cannot be undone</small></p>
                </div>
                <form action="/pasien/<?= $hapus->uuid; ?>" method="post">
                    <?= csrf_field(); ?>
